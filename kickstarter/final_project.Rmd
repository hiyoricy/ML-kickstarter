...
data.for.f <- data1.temp %>% select(successful, everything())
...
for (p in 1:14) 
{
  fit.rf <-ranger(as.factor(successful)~., data=data.for.train, mtry=p, num.trees=250, splitrule = "gini",importance = "impurity", oob.error = TRUE)
