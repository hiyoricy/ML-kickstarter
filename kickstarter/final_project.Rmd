...
to_remove <- c("X.1", "creator", "currency_symbol", "currency_trailing_code", "disable_communication", "friends", "fx_rate", "is_backing", "permissions", "photo", "profile","source_url", "static_usd_rate","urls")
...
ParseJSONColumn <- function(x)  {
     gsub(",,", ",", str_c("[ ", str_c(x, collapse = ",", sep=" "), " ]"))  %>% 
     %>% fromJSON(flatten = T) %>% 
     as.tibble()
} 
